...
<body>
	...
	<main class="pageTop pages">
		<section class="pageTop__kv">
			<div class="kv__inr">
				<h2 class="kv__ttl">
					<img class="-pc-only" src="./Image/Front/img_kv_ttl.svg" alt>
					<img class="-sp-only" src="./Image/Front/img_kv_ttl_sp.svg" alt>
				</h2>
		...
		<section class="pageTop__company">
			...
			<div class="company__slide swiper">
				<div class="swiper-wrapper">
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_1.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_2.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_3.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_4.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_5.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_6.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_7.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_8.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_9.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_10.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_11.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_12.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_13.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_14.png" alt></div>
					<div class="slide__item swiper-slide"><img src="./Image/Front/logo_15.png" alt></div>
				</div>
			</div>
		</section>
		...
		<section class="pageTop__information">
			<div class="inner">
				...
				<ul class="information__cateLst">
					...
					<li>VC</li>
					<li>FAS</li>
					<li>上場企業の財務・税務・経理マネージャー候補</li>
					<li>メガベンチャー・IPOスタートアップ案件</li>
				</ul>

				<div class="information__banners">
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">スタートアップCFOへの挑戦！次世代を代表するCFOへ</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">スタートアップ</span>ファイナンス
								</div>
								<p class="block__txt">CFO</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">800</span>万円</span>
									<span> 〜<span class="-lg">2,000</span>万円</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">BIG4 FASであなたの<br>可能性を広げる！</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">コンサルティング<br>ファーム</span>コーポレート<br>ファイナンス
								</div>
								<p class="block__txt">シニアアソシエイト</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">500</span>万円</span>
									<span> 〜<span class="-lg">1,500</span>万円</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">大手税理士法人で税務を極める！</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">大手税理士法人</span>税務
								</div>
								<p class="block__txt">スタッフリーダー</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">800</span>万円</span>
									<span> 〜<span class="-lg">1,100</span>万円</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">キャピタリストとして、起業家とともに未来を切り開く！</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">プロフェッショナル<br>ファーム</span>ＶＣ
								</div>
								<p class="block__txt">キャピタリスト</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">500</span>万円</span>
									<span> 〜<span class="-lg">1,300</span>万円</span>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">グローバルで活躍する人材へ。<br>5大商社への挑戦</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">5大商社</span>財務経理
								</div>
								<p class="block__txt">スタッフ</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">650</span>万円</span>
									<span> 〜<span class="-lg">2,000</span>万円</span>
								</p>
							</div>
						</div>
					...
					<div class="banner__item">
						<div class="banner__head">
							<p class="head__ttl">経理財務のエキスパートへ。<br>上場企業マネージャー募集中</p>
						</div>
						<div class="banner__cnt">
							<div class="cnt__block">
								<div class="block__sub">
									<span class="-cate">上場企業</span>経理財務
								</div>
								<p class="block__txt">マネージャー</p>
							</div>
							<div class="cnt__block">
								<p class="block__tag">年収</p>
								<p class="block__price">
									<span>
										<span class="-md">1,000</span>万円</span>
									<span> 〜<span class="-lg">1,500</span>万円</span>
								</p>
							</div>
						</div>
				...
				<?php require("./components/sec-btn.php") ?>
			</div>
		</section>
		...
		<section class="pageTop__career">
			<div class="inner">
				...
				<p class="career__txt">CPASSキャリアの転職支援サービスを利用し、理想のキャリアを歩むことに成功した方々を紹介します。転職のきっかけやどのように転職先を決定したかなど、具体的な事例を紹介しておりますので、転職を検討している方はご参考ください。</p>

				<div class="career__lst">
					<div class="career__item">
						<div class="item__head">
							<figure class="head__icon">
								<img src="./Image/Front/img_career01.png" alt>
							</figure>
							<p class="head__ttl">BIG4監査法人から<br>
								<span class="-yel">スタートアップCFOへ</span>
							</p>
						</div>
						<div class="item__cnt">
							<p class="item__txt01 -pc-only">
								IPO監査インチャージ<span class="-bg">年収<span class="-num">900</span>万円</span>
							</p>
							<p class="item__txt01 -sp-only">
								<span class="-bg">転職前</span>
								<span class="item__txt01Detail">IPO監査インチャージ<br>年収900万円</span>
							</p>
							<p class="item__txt03 -sp-only">転職後</p>
							<p class="item__txt02">CFO<span class="-bg">年収<span class="-num">1,200</span>万円＋SO</span>
							</p>
						</div>
					</div>
					...
					<div class="career__item">
						<div class="item__head">
							<figure class="head__icon">
								<img src="./Image/Front/img_career02.png" alt>
							</figure>
							<p class="head__ttl">コンサルティング<br>ファームから<span class="-yel">5大商社へ</span>
							</p>
						</div>
						<div class="item__cnt">
							<p class="item__txt01 -pc-only">
								会計コンサルタント<span class="-bg">年収<span class="-num">1,000</span>万円</span>
							</p>
							<p class="item__txt01 -sp-only">
								<span class="-bg">転職前</span>
								<span class="item__txt01Detail">会計コンサルタント<br>年収1,000万円</span>
							</p>
							<p class="item__txt03 -sp-only">転職後</p>
							<p class="item__txt02">5大商社 財務経理<span class="-bg">年収<span class="-num">1,300</span>万円</span>
							</p>
						</div>
					</div>
					...
					<div class="career__item">
						<div class="item__head">
							<figure class="head__icon">
								<img src="./Image/Front/img_career03.png" alt>
							</figure>
							<p class="head__ttl">BIG4監査法人から<br>
								<span class="-yel">大手上場企業メーカーへ</span>
							</p>
						</div>
						<div class="item__cnt">
							<p class="item__txt01 -pc-only">
								監査スタッフ<span class="-bg">年収<span class="-num">700</span>万円</span>
							</p>
							<p class="item__txt01 -sp-only">
								<span class="-bg">転職前</span>
								<span class="item__txt01Detail">監査スタッフ 年収700万円</span>
							</p>
							<p class="item__txt03 -sp-only">転職後</p>
							<p class="item__txt02">上場企業経理<span class="-bg">年収<span class="-num">900</span>万円</span>
							</p>
						</div>
					</div>
					...
					<div class="career__item">
						<div class="item__head">
							...
							<p class="head__ttl">会計事務所から<br>
								<span class="-yel">大手税理士法人へ</span>
							</p>
						</div>
						<div class="item__cnt">
							<p class="item__txt01 -pc-only">
								税理スタッフ<span class="-bg">年収<span class="-num">700</span>万円</span>
							</p>
							<p class="item__txt01 -sp-only">
								<span class="-bg">転職前</span>
								<span class="item__txt01Detail">税理スタッフ 年収700万円</span>
							</p>
							<p class="item__txt03 -sp-only">転職後</p>
							<p class="item__txt02">税務スタッフリーダー<span class="-bg">年収<span class="-num">900</span>万円</span>
							</p>
						</div>
					</div>

					<div class="career__item -pc-only">
						<div class="item__head">
							<figure class="head__icon">
								<img src="./Image/Front/img_career02.png" alt>
							</figure>
							<p class="head__ttl">BIG4FASから<br>
								<span class="-yel">ベンチャー<br>キャピタリストへ</span>
							</p>
						</div>
						<div class="item__cnt">
							<p class="item__txt01 -pc-only">
								BIG4FAS<span class="-bg">年収<span class="-num">800</span>万円</span>
							</p>
							<p class="item__txt01 -sp-only">
								<span class="-bg">転職前</span>
								<span class="item__txt01Detail">BIG4FAS 年収800万円</span>
							</p>
							<p class="item__txt03 -sp-only">転職後</p>
							<p class="item__txt02">VC アソシエイト<span class="-bg">年収<span class="-num">1,100</span>万円</span>
							</p>
						</div>
					</div>
				...
				<a href="https://sub.cpa-career.jp/case" class="sec__detail">詳細はこちら</a>
			</div>
		</section>
				...
				<div class="account__lst">
					<a href="https://sub.cpa-career.jp/about" target="_blank" rel="noopener" class="account__item">
						<figure class="item__img">
							<img src="./Image/Front/img_account01.jpg" alt>
						</figure>
						<p class="item__ttl">
							<span>2,500名以上の</span>
							<br>
					...
					<a href="https://sub.cpa-career.jp/about" target="_blank" rel="noopener" class="account__item">
						<figure class="item__img">
							<img src="./Image/Front/img_account02.jpg" alt>
						</figure>
						<p class="item__ttl">
							<span>心から納得できる</span>
							<br>
					...
					<a href="https://sub.cpa-career.jp/about" target="_blank" rel="noopener" class="account__item">
						<figure class="item__img">
							<img src="./Image/Front/img_account03.jpg" alt>
						</figure>
						<p class="item__ttl">
					...
					<a href="https://sub.cpa-career.jp/about" target="_blank" rel="noopener" class="account__item">
						<figure class="item__img">
							<img src="./Image/Front/img_account04.jpg" alt>
						</figure>
						<p class="item__ttl">
							<span>会計士だから</span>
							<br>
				...
				<div class="cpass__banner">
					<div class="banner__head">
						...
						<figure class="banner__img">
							<img src="./Image/Front/img_cpass01.png" alt>
						</figure>
					</div>
					<div class="banner__cnt">
						<p class="banner__txt">キャリア名鑑・キャリア診断など会計人材のための<br class="-pc-only">
							...
							<span class="-w__yel">CPAグループの転職コンサルタントサービス</span> だから、<span class="-w__yel -sm">多くの方にご支持</span> いただいています。
						</p>
					</div>
				</div>
			</div>
		...
		<section class="pageTop__carrier">
			<div class="inner">
				...
				<div class="carrier__banners">
					<div class="banner__block">
						...
						<a href="https://www.cpa-learning.com/career-directory/diagnosis/" target="_blank" rel="noopener" class="block__btn">
							<img src="./Image/Front/btn_carrier01.png" alt="キャリア診断 はこちら！" class="-pc-only">
							<img src="./Image/Front/btn_carrier01-sp.png" alt="キャリア診断 はこちら！" class="-sp-only">
						</a>
					</div>
					...
					<div class="banner__block">
						...
						<a href="https://www.cpa-learning.com/career-directory/" class="block__btn" target="_blank" rel="noopener">
							<img src="./Image/Front/btn_carrier02.png" alt="会計人材のキャリア名鑑" class="-pc-only">
							<img src="./Image/Front/btn_carrier02-sp.png" alt="会計人材のキャリア名鑑" class="-sp-only">
						</a>
					</div>
				</div>
				...
				<div class="carrier__frame">
					<h3 class="frame__ttl">
						<span class="-yel">CPASSキャリア</span>と<br>転職サイトとの<span class="-yel">違い</span>とは？
					</h3>

					<p class="frame__txt">CPASSキャリアの転職エージェントサービスと総合人材紹介エージェントの比較を行いました。CPASSキャリアは、会計業界に特化した知識と経験があるからこそ、質の高いアドバイスや専門性の高いサポートを提供することができますので、会計業界でキャリアにお悩みの方は、ぜひご利用ください。</p>
					...
					<div class="frame__tbl">
						<table>
							<tr>
								...
								<th>
									<img src="./Image/Front/img_carrier_logo01.svg" alt="CPASS CAREER" class="-img01">
								</th>
								<th class="-pc-only">
									<p>総合人材紹介エージェント</p>
								</th>
				...
				<div class="carrier__site">
					...
					<a href="https://cpa-jobs.jp/" target="_blank" rel="noopener" class="site__btn">
						<img src="Image/Front/btn_carrier03.png" alt="CPA Jobs">
					</a>
				</div>
			</div>
		</section>
			...
			<div class="inner">
				...
				<div class="faq__lst">
					<dl class="faq__block sec__accor">
						...
						<dd class="block__cnt">
							<p class="faq__txt">転職コンサルタント歴が10～20年のキャリアコンサルタントと、現役で活躍している複数の公認会計士がご相談に応じます。キャリアのプロの見解と、公認会計士同士だからこその意見交換の場が同時に得られます。</p>
						</dd>
					</dl>

			...
			<div class="item__cnt">
				<div class="item__infor">
					<div class="infor__left">
						...
						<span>年収<span class="-num"><?php echo get_field('single_case_profile_prev_income', $post->ID) ?></span>万円</span>
					</div>
					<div class="infor__right">
						<?php echo get_field('single_case_profile_current_industry', $post->ID) ?>
						<span>年収<span class="-num"><?php echo get_field('single_case_profile_current_income', $post->ID) ?></span>万円</span>
					</div>
				</div>

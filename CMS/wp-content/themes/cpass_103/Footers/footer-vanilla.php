	...
	<div class="footer__inner -pc-only">
		<div class="footer__cnt">
			...
			<div class="footer__menu">
				<ul class="menu__lst">
					<li class="lst__item">
						<a href="https://sub.cpa-career.jp/recruit" target="_blank" rel="noopener">
							求人
						</a>
					</li>
					<li class="lst__item">
				...
				<ul class="menu__lst">
					...
					<!-- <li class="lst__item">
						<a href="https://www.cpa-learning.com/career-directory/" target="_blank"
							rel="noopener">
							キャリア名鑑
						</a>
					</li> -->
			...
			<div class="footer__bottomLeft">
				<div class="footer__bottomLeftFlex">
					...
					<a href="https://www.cpa-learning.com/career-directory/" target="_blank" rel="noopener" class="footer__bottomLeftLink">
						<img src="<?php echo get_template_directory_uri() . '/Image/common/banner_footer_2.png' ?>" alt="">
					</a>
					<a href="https://cpa-career-new-journey.studio.site/" target="_blank" rel="noopener" class="footer__bottomLeftLink">
						<img src="<?php echo get_template_directory_uri() . '/Image/common/banner_footer_3.png' ?>" alt="">
					</a>
				</div>
			</div>
		</div>
	...
	<div class="footer__inner footer__inner--sp -sp-only">
		...
		<div class="footer__bottom">
			...
			<div class="footer__bottomLeft">
				<div class="footer__bottomLeftFlex">
					<a href="https://cpass-net.jp/" target="_blank" rel="noopener" class="footer__bottomLeftLink">
						<img src="<?php echo get_template_directory_uri() . '/Image/common/banner_footer_1.png' ?>" alt="cpass">
					</a>
					<a href="https://www.cpa-learning.com/career-directory/" target="_blank" rel="noopener" class="footer__bottomLeftLink">
						<img src="<?php echo get_template_directory_uri() . '/Image/common/banner_footer_2.png' ?>" alt="会計人材のキャリア名鑑">
					</a>
					<a href="https://cpa-career-new-journey.studio.site/" target="_blank" rel="noopener" class="footer__bottomLeftLink">
						<img src="<?php echo get_template_directory_uri() . '/Image/common/banner_footer_3.png' ?>" alt="Cpass 就活ポータル">
					</a>
				</div>

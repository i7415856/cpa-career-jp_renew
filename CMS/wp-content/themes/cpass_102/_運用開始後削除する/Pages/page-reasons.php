...
<main class="pageAbout pages">
	...
	<section class="about_info">
		<div class="inner -maw-90rem">
			<div class="info_box -box1">
				<p class="info_txt">数え切れないほど多くの職種や業界がある中で、私達は会計人材に関係のある職種と業界にのみ特化してサービスを提供しています。会計人材に特化することで、会計業界特有のニーズやキャリアパスを深く理解することが可能になるからです。</p>
				<p class="info_txt">最初の就職先、何年間の実務経験があるか、お持ちの資格を簡単に教えていただければ、そこから広がるキャリアの可能性や、転職可能性に至るまで、ほぼ的確に言い当てられる自信があります。</p>
				<p class="info_txt">だから、到底無理と思われるご提案は一切しませんし、無理強いをすることもありません。ただし、前向きなチャレンジに対してのご支援となれば話は別です。全力でご支援させていただきます。</p>
				<p class="info_txt">また、どうしても叶えたいキャリアがあって、そこに行くために必要な経験が足りないような状況であれば、私たちはその時が訪れるまで何年でも待つつもりです。そして、然るべきタイミングで然るべきご支援をさせていただきます。</p>
			...
			<div class="info_box -box2">
				...
				<p class="info_txt">CPASSキャリアは、公認会計士の資格スクール『CPA会計学院』と共に会計人材のキャリア構築のサポートをするために誕生しました。<br>
					私たちは、「絶対に転職を煽るようなことはしない」、「マッチ度合いの低い案件を薦めたりしない」、「相手のペースを大切にする」という姿勢を大切に、本当の求職者第一主義を貫く転職エージェントを目指すことを約束します。</p>
			</div>
		</div>
	</section>
		...
		<div class="inner">
			...
			<div class="reason_list">
				...
				<div class="reason_item -reason3">
					...
					<div class="-sp-only">
						<div class="reason_txt">CPASSキャリアは、あなたのキャリアを生涯にわたってサポートします。ニーズに応じた定期的なフォローだけでなく、グループサービスで展開する交流事<span class="-js_more_dots">…</span><p class="-js_more_ttl">もっと読む</p><span class="-js_more_cnt">業や学びのサポートも提供しています。3つの事業を通じて、すべての会計人材の可能性を広げ、人生を豊かにする応援をします。交流と学びの機会を活用し、キャリアの可能性を最大限に引き出してください。</span>
						</div>
					</div>

					<!-- <div class="-sp-only">
						<p class="reason_txt">CPASSキャリアは、あなたのキャリアを生涯にわたってサポートします。ニーズに応じた定期的なフォローだけでなく、グループサービスで展開する交流事<span class="-js_more_dots">…</span></p>
						<p class="-js_more_ttl">もっと読む</p>
						<p class="reason_txt -js_more_cnt">業や学びのサポートも提供しています。3つの事業を通じて、すべての会計人材の可能性を広げ、人生を豊かにする応援をします。交流と学びの機会を活用し、キャリアの可能性を最大限に引き出してください。</p>
					</div> -->
	...
	<section class="about_cv">
		<div class="inner">
			<p class="cv_head">一流のコンサルタントが<br>あなたの転職成功を徹底的にサポート！</p>
			<div class="sec__btnWrap">
				<a href="https://ef.cpa-career.jp/CPASSCAREER_entryform/" target="_blank" rel="noopener" class="sec__btn cv_btn">無料転職支援サービス<span class="-yel">お申し込み</span></a>
				<p class="sec__btnCaption">ご登録済みの方は<a class="kv__btnCaptionLink" target="_blank" rel="noopener" href="https://cpass.eeasy.jp/cpass/2022090101">こちら</a></p>
			</div>
		</div>
	</section>
</main>

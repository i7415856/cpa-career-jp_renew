	...
	<section class="about_info">
		<div class="inner -maw-90rem">
			<div class="info_box -box1">
				<p class="info_txt">数え切れないほど多くの職種や業界がある中で、<br class="-pc-only">私たちは会計人材に関係のある職種と業界にのみ特化してサービスを提供させていただきます。<br class="-pc-only">会計人材に特化することで、会計業界特有のニーズやキャリアパスを深く理解できます。</p>
	...
	<section class="about_cv">
		<div class="inner">
			...
			<div class="sec__btnWrap">
				...
				<p class="sec__btnCaption">ご登録済みの方は<a class="kv__btnCaptionLink" target="_blank" rel="noopener" href="https://cpass.eeasy.jp/cpass/20240522hp">こちら</a></p>
			</div>
		</div>
	</section>
</main>

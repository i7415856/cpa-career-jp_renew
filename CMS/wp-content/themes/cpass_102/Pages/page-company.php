		...
		<section class="pageCompany__about">
			<div class="inner -maw-80rem">
				...
				<div class="about__gallery">
					<figure class="gallery__img01"><img src="<?php echo get_template_directory_uri() ?>/Image/company/img01.jpg" alt=""></figure>
					<figure class="gallery__img02"><img src="<?php echo get_template_directory_uri() ?>/Image/company/img02.jpg" alt=""></figure>
				</div>
			</div>
		</section>

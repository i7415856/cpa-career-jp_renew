		...
		<div class="inner">
			...
			<?php if (have_rows('recruit_tags')) { ?>
				<div class="jobInfo_cats">
					...
					<?php } ?>
					<span class="jobInfo_cat">コンサル</span>
					<span class="jobInfo_cat">VC</span>
					<span class="jobInfo_cat">FAS</span>
					<span class="jobInfo_cat">上場企業の財務・税務・経理マネージャー候補</span>
					<span class="jobInfo_cat">メガベンチャー・IPOスタートアップ案件</span>
				</div>
			<?php } ?>

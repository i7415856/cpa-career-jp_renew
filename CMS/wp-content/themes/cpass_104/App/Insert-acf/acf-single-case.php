	...
	acf_add_local_field_group(array(
		...
		'fields' => [
			...
			[
				...
				'type' => 'wysiwyg',
				'tabs' => 'visual',
				'instructions' => '太字にするとフロント画面で文字が黄色になります。<br>推奨文字数 : 1行あたり13文字',
				'required' => 1,
				'toolbar' => 'bold_only',
				'media_upload' => 0,
			],
			[
				...
				'type' => 'wysiwyg',
				'tabs' => 'visual',
				'instructions' => '太字にするとフロント画面で文字が黄色になります。<br>推奨文字数 : 1行あたり23文字',
				'required' => 1,
				'toolbar' => 'bold_only',
				'media_upload' => 0,
			],
			...
			[
				...
				'required' => 1,
				'maxlength' => 15,
				'instructions' => '最大15文字。推奨文字数 : 10文字以下',
			],
			[
			...
			[
				...
				'sub_fields' => [
					[
						...
						'type' => 'wysiwyg',
						'instructions' => '太字にするとフロント画面で白文字青背景になります。 推奨文字数 : 40文字以下',
						'toolbar' => 'bold_only',
						'media_upload' => 0,
						'required' => 1,
					]
			...
			[
				...
				'type' => 'textarea',
				'required' => 1,
				'instructions' => '推奨文字数 : 400文字以上（デザインデータには600文字ほど入力されていました。）',
			],
			//========================
			// POINT
			//========================
			...
			[
				...
				'sub_fields' => [
					[
						...
						'media_upload' => 0,
						'required' => 1,
						'instructions' => '推奨文字数 : 50文字程度（32文字目あたりでPC時に改行します）',
					],
				],
			],
		],

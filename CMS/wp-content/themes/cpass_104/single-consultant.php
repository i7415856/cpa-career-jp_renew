				...
				<article class="singleConsultantHistory">
					...
					<ul class="singleConsultantHistory__list">
						<?php while (have_rows('single_consultant_history')) {
							the_row();
							if (get_sub_field('single_consultant_history_year') !== "現在に至る") {
						?>
								<li class="singleConsultantHistory__item">
									<p class="singleConsultantHistory__itemYear"><?php echo get_sub_field('single_consultant_history_year') ?></p>
									<p class="singleConsultantHistory__itemText"><?php echo get_sub_field('single_consultant_history_text') ?></p>
								</li>
							<?php } ?>
						<?php } ?>
						<li class="singleConsultantHistory__item">
							<p class="singleConsultantHistory__itemYear">現在に至る</p>
						</li>
					</ul>
				</article>
			<?php } ?>
